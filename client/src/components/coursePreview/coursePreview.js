          ...
          <div className="w">
            ...
            <div className="extra">
              <div className="page-share">
                <a
                  onClick={() => Share.shareToQQZone(course.title, `/class/1/`)}
                >
                  <CustomIcon type="qq" color="#b6b9bc" size={26} />
                </a>
                <a
                  onClick={() => Share.shareToDouban(course.title, `/class/2/`)}
                >
                  <CustomIcon type="douban_F" color="#b6b9bc" size={24} />
                </a>
                <a
                  onClick={() => Share.shareToWeibo(course.title, `/class/2/`)}
                >
